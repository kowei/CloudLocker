...
class GATTDefinitions {
    ...
    companion object SIG_UUID {
        val SIG_USER_UUID = UUID.fromString("00002901-0000-1000-8000-00805f9b34fb")
        val SIG_CLIENT_UUID = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb")
    }
    init {
        // GATT Services
